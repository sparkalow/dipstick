...
The full spec is in `spec.md` — read it before starting any step. What follows is a condensed reference of the parts most load-bearing for implementation decisions.
...
If a task seems to need a new dependency, propose it and explain why.
